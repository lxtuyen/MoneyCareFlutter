...
import 'package:money_care/presentation/screens/statistics/widgets/chart/chart_card.dart';
...
class _StatisticsScreenState extends State<StatisticsScreen> {
  ...
  Future<void> loadData() async {
    transactionController.getTotalByDateLstMonth(userId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<FlSpot> convertToSpots7Days(List<TotalByDate> data, DateTime endDate) {
    ...
    List<TotalByDate> getDataBySelected(TotalsByDate totals, String selected) {
      if (selected == 'chi') {
