...
import 'package:money_care/presentation/screens/chatbot/widgets/bubble.dart';
import 'package:money_care/presentation/screens/chatbot/widgets/welcome_option.dart';
...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  final List<QuickOption> _options = const [
    QuickOption(
      title: 'Thêm chi tiêu',
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      chatController.replaceLastBotMessage('Lỗi gọi chatbot: $e');
      _scrollToBottom();
    }
  }
